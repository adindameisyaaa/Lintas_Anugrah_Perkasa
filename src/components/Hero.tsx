    ...
    <section className="relative min-h-[80vh] flex items-center pt-20 overflow-hidden bg-white dark:bg-transparent border-b border-gray-100 dark:border-transparent">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 text-gray-900 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-white dark:to-white/60 leading-[1.1]">
            {title}
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 dark:text-foreground/60 mb-10 leading-relaxed max-w-2xl">
            {subtitle}
          </p>
          {ctaText && ctaLink && (
            <Link
