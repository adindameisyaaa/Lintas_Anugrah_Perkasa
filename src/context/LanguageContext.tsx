...
const translations = {
  en: {
    ...
    "hero.subtitle": "PT. Lintas Anugrah Perkasa provides world-class GPS tracking and logistics services tailored to your business needs.",
    ...
    "about.mission.desc": "To provide reliable, high-quality logistics and tracking services that empower businesses to operate with confidence and efficiency.",
    "about.vision.title": "Our Vision",
    "about.vision.desc": "To be the leading choice for logistics and security solutions in the region, recognized for our innovation, integrity, and customer-centric approach.",
  ...
  id: {
    ...
    "hero.subtitle": "PT. Lintas Anugrah Perkasa menyediakan layanan pelacakan GPS dan logistik kelas dunia yang disesuaikan dengan kebutuhan bisnis Anda.",
    ...
    "about.mission.desc": "Menyediakan layanan logistik dan pelacakan yang andal dan berkualitas tinggi yang memberdayakan bisnis untuk beroperasi dengan percaya diri dan efisien.",
    "about.vision.title": "Visi Kami",
    "about.vision.desc": "Menjadi pilihan utama untuk solusi logistik dan keamanan di kawasan ini, diakui karena inovasi, integritas, dan pendekatan yang berpusat pada pelanggan.",
